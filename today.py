...
USER_NAME = os.environ['USER_NAME'] # 'williamengbjerg'
DEV_SINCE = datetime.datetime(2006, 1, 1)  # first year writing code -- drives 'Experience'
QUERY_COUNT = {'user_getter': 0, 'follower_getter': 0, 'graph_repos_stars': 0, 'recursive_loc': 0, 'graph_commits': 0, 'loc_query': 0}


def experience_readme(start):
    """
    Returns years of experience since `start`
    e.g. '20 years (since 2006)'
    """
    years = relativedelta.relativedelta(datetime.datetime.today(), start).years
    return '{} {} (since {})'.format(years, 'year' + format_plural(years), start.year)
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(experience_readme, DEV_SINCE)
    formatter('experience calculation', age_time)
